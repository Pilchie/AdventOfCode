...
fn main() -> Result<(), Error> {
    ...
    if let Some(first_invalid) = first_invalid(&input, 25) {
        println!("Found {} as first invalid", first_invalid);
    } else {
        println!("Didn't find an invalid input");
    }
...
pub fn first_invalid(input: &[usize], preamble_length: usize) -> Option<usize> {
...
mod tests {
    ...
    fn test_sequence() {
        ...
        assert_eq!(Some(127), first_invalid(&input, 5));
    }
